...
class Disk {
  private:
    ...
    static constexpr const double avg_seek_time=6.46;
    static constexpr const double avg_rotation_latency=4.17;
    static constexpr const double avg_transfer_time_per_block=0.20 * 320;
